...
# NEW: Update-PCInfo using Start-Job + DispatcherTimer (no freezing).
    ...
    $Global:PCInfoTimer.Add_Tick({
        ...
        if ($newData) {
            ...
            try {
                ...
                if ($result.EntraIDStatus -eq "Not Joined") {$Global:PcEntraIDStatusBlock.Background = "#DC3545"}
                else {$Global:PcEntraIDStatusBlock.Background = "#28A745"}
                ...
                <StackPanel Orientation="Vertical">
                    ...
                    <Grid>
                        ...
                        <TextBox Grid.Row="0" Grid.Column="1" x:Name="DomainControllerBox" FontSize="14" Text="$DefaultDomainController"
                                 BorderBrush="#1E90FF" BorderThickness="1" Padding="2" Margin="0,5,0,0" IsReadOnly="True" Background="LightGray"/>
