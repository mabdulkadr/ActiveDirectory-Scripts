...
param (
    [int]$DaysInactive     = 180,                                            # Number of days of inactivity for filtering inactive computers
    [string]$SearchBaseOU  = "OU=Domain Computers,DC=ABC,DC=local"           # Organizational Unit (OU) for searching computers
)
